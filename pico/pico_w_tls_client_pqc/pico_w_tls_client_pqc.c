...
#define INITIAL_SLEEP_TIME_MS    5000
...
void run_TLS_CLIENT_Test(void) {
    ...
    /* cert init and parse happens internally */
    /*
    ...
    char crt_buf[1024];
    char *prefix = "";
    mbedtls_x509_crt_info((char *) crt_buf, 1024, prefix, &cacert);
    printf(crt_buf);
    */
...
int main() {
    stdio_init_all();
    printf("\n *** Client started *** \n\n");
    sleep_ms(INITIAL_SLEEP_TIME_MS);
