...
#define MBEDTLS_TLS_ECDHE_DILITHIUM_WITH_AES_256_GCM_SHA384     0xC0EF
#define MBEDTLS_TLS_KYBER_DILITHIUM_WITH_AES_256_GCM_SHA384     0xC0FA // CHANGED SHA256 -> SHA384
#define MBEDTLS_TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA256     0xC0FB
#define MBEDTLS_TLS_KYBER_ECDSA_WITH_AES_256_GCM_SHA384		  0xC0FC
#define MBEDTLS_TLS_ECDHE_SPHINCS_WITH_AES_256_GCM_SHA384     0xC0FD
#define MBEDTLS_TLS_KYBER_SPHINCS_WITH_AES_256_GCM_SHA384     0xC0FE
#define MBEDTLS_TLS_ECJPAKE_WITH_AES_128_CCM_8          0xC0FF  /**< experimental */

#define MBEDTLS_TLS_SABER_DILITHIUM_WITH_AES_256_GCM_SHA384     0xC100
#define MBEDTLS_TLS_SABER_ECDSA_WITH_AES_256_GCM_SHA384		  0xC101
#define MBEDTLS_TLS_SABER_SPHINCS_WITH_AES_256_GCM_SHA384     0xC102
...
typedef enum {
    ...
    MBEDTLS_KEY_EXCHANGE_ECDHE_DILITHIUM,
    MBEDTLS_KEY_EXCHANGE_KYBER_ECDSA,
    MBEDTLS_KEY_EXCHANGE_KYBER_SPHINCS,
    MBEDTLS_KEY_EXCHANGE_KYBER_DILITHIUM,
    MBEDTLS_KEY_EXCHANGE_SABER_ECDSA,
    MBEDTLS_KEY_EXCHANGE_SABER_SPHINCS,
    MBEDTLS_KEY_EXCHANGE_SABER_DILITHIUM,
...
/* Key exchanges using SABER */
#if	defined(MBEDTLS_KEY_EXCHANGE_SABER_ECDSA_ENABLED)   || \
	defined(MBEDTLS_KEY_EXCHANGE_SABER_SPHINCS_ENABLED) || \
	defined(MBEDTLS_KEY_EXCHANGE_SABER_DILITHIUM_ENABLED)
#define MBEDTLS_KEY_EXCHANGE__SOME__SABER_ENABLED
#endif
...
#if defined(MBEDTLS_KEY_EXCHANGE__SOME__SABER_ENABLED)
static inline int mbedtls_ssl_ciphersuite_uses_saber(const mbedtls_ssl_ciphersuite_t *info)
{
	switch (info->key_exchange)
	{
	case MBEDTLS_KEY_EXCHANGE_SABER_SPHINCS:
...
#endif /* MBEDTLS_KEY_EXCHANGE__SOME__SABER_ENABLED) */
