...
static const int ciphersuite_preference[] =
{
	...
	/* PQ experimental */
#if defined(MBEDTLS_KEY_EXCHANGE_SABER_DILITHIUM_ENABLED)
	MBEDTLS_TLS_SABER_DILITHIUM_WITH_AES_256_GCM_SHA256,
#endif
#if defined(MBEDTLS_KEY_EXCHANGE_SABER_SPHINCS_ENABLED)
	MBEDTLS_TLS_SABER_SPHINCS_WITH_AES_256_GCM_SHA256,
#endif
#if defined(MBEDTLS_KEY_EXCHANGE_SABER_ECDSA_ENABLED)
	MBEDTLS_TLS_SABER_ECDSA_WITH_AES_256_GCM_SHA256,
#endif  
  
#if defined(MBEDTLS_KEY_EXCHANGE_KYBER_DILITHIUM_ENABLED)
	MBEDTLS_TLS_KYBER_DILITHIUM_WITH_AES_256_GCM_SHA256,
#endif
#if defined(MBEDTLS_KEY_EXCHANGE_ECDHE_DILITHIUM_ENABLED)
...
#endif
#if defined(MBEDTLS_KEY_EXCHANGE_ECDHE_SPHINCS_ENABLED)
	...
	MBEDTLS_TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA256,
...
static const mbedtls_ssl_ciphersuite_t ciphersuite_definitions[] =
{
	...
	{ MBEDTLS_TLS_SABER_DILITHIUM_WITH_AES_256_GCM_SHA256, "TLS-SABER-DILITHIUM-WITH-AES-256-GCM-SHA256",
	MBEDTLS_CIPHER_AES_256_GCM, MBEDTLS_MD_SHA256, MBEDTLS_KEY_EXCHANGE_SABER_DILITHIUM,
...
#endif /* MBEDTLS_AES_C */
#endif /* MBEDTLS_KEY_EXCHANGE_SABER_DILITHIUM_ENABLED */
#if defined(MBEDTLS_KEY_EXCHANGE_KYBER_DILITHIUM_ENABLED)
#if defined(MBEDTLS_AES_C)
#if defined(MBEDTLS_SHA256_C)
#if defined(MBEDTLS_GCM_C)
	{ MBEDTLS_TLS_KYBER_DILITHIUM_WITH_AES_256_GCM_SHA256, "TLS-KYBER-DILITHIUM-WITH-AES-256-GCM-SHA256",
	MBEDTLS_CIPHER_AES_256_GCM, MBEDTLS_MD_SHA256, MBEDTLS_KEY_EXCHANGE_KYBER_DILITHIUM,
	MBEDTLS_SSL_MAJOR_VERSION_3, MBEDTLS_SSL_MINOR_VERSION_3,
	MBEDTLS_SSL_MAJOR_VERSION_3, MBEDTLS_SSL_MINOR_VERSION_3,
	0 },
#endif /* MBEDTLS_GCM_C */
#endif /* MBEDTLS_SHA256_C */
#endif /* MBEDTLS_AES_C */
#endif /* MBEDTLS_KEY_EXCHANGE_KYBER_DILITHIUM_ENABLED */
#if defined(MBEDTLS_KEY_EXCHANGE_ECDHE_DILITHIUM_ENABLED)
#if defined(MBEDTLS_AES_C)
#if defined(MBEDTLS_SHA256_C)
#if defined(MBEDTLS_GCM_C)
	{ MBEDTLS_TLS_ECDHE_DILITHIUM_WITH_AES_256_GCM_SHA256, "TLS-ECDHE-DILITHIUM-WITH-AES-256-GCM-SHA256",
	MBEDTLS_CIPHER_AES_256_GCM, MBEDTLS_MD_SHA256, MBEDTLS_KEY_EXCHANGE_ECDHE_DILITHIUM,
	MBEDTLS_SSL_MAJOR_VERSION_3, MBEDTLS_SSL_MINOR_VERSION_3,
	MBEDTLS_SSL_MAJOR_VERSION_3, MBEDTLS_SSL_MINOR_VERSION_3,
	0 },
#endif /* MBEDTLS_GCM_C */
#endif /* MBEDTLS_SHA256_C */
#endif /* MBEDTLS_AES_C */
#endif /* MBEDTLS_KEY_EXCHANGE_ECDHE_DILITHIUM_ENABLED */
#if defined(MBEDTLS_KEY_EXCHANGE_SABER_SPHINCS_ENABLED)
#if defined(MBEDTLS_AES_C)
#if defined(MBEDTLS_SHA256_C)
#if defined(MBEDTLS_GCM_C)
	{ MBEDTLS_TLS_SABER_SPHINCS_WITH_AES_256_GCM_SHA256, "TLS-SABER-SPHINCS-WITH-AES-256-GCM-SHA256",
	MBEDTLS_CIPHER_AES_256_GCM, MBEDTLS_MD_SHA256, MBEDTLS_KEY_EXCHANGE_SABER_SPHINCS,
	MBEDTLS_SSL_MAJOR_VERSION_3, MBEDTLS_SSL_MINOR_VERSION_3,
	MBEDTLS_SSL_MAJOR_VERSION_3, MBEDTLS_SSL_MINOR_VERSION_3,
	0 },
#endif /* MBEDTLS_GCM_C */
#endif /* MBEDTLS_SHA256_C */
#endif /* MBEDTLS_AES_C */
#endif /* MBEDTLS_KEY_EXCHANGE_SABER_SPHINCS_ENABLED */
#if defined(MBEDTLS_KEY_EXCHANGE_KYBER_SPHINCS_ENABLED)
#if defined(MBEDTLS_AES_C)
#if defined(MBEDTLS_SHA256_C)
#if defined(MBEDTLS_GCM_C)
	{ MBEDTLS_TLS_KYBER_SPHINCS_WITH_AES_256_GCM_SHA256, "TLS-KYBER-SPHINCS-WITH-AES-256-GCM-SHA256",
	MBEDTLS_CIPHER_AES_256_GCM, MBEDTLS_MD_SHA256, MBEDTLS_KEY_EXCHANGE_KYBER_SPHINCS,
	MBEDTLS_SSL_MAJOR_VERSION_3, MBEDTLS_SSL_MINOR_VERSION_3,
	MBEDTLS_SSL_MAJOR_VERSION_3, MBEDTLS_SSL_MINOR_VERSION_3,
	0 },
#endif /* MBEDTLS_GCM_C */
#endif /* MBEDTLS_SHA256_C */
#endif /* MBEDTLS_AES_C */
#endif /* MBEDTLS_KEY_EXCHANGE_KYBER_SPHINCS_ENABLED */
#if defined(MBEDTLS_KEY_EXCHANGE_SABER_ECDSA_ENABLED)
#if defined(MBEDTLS_AES_C)
#if defined(MBEDTLS_SHA256_C)
#if defined(MBEDTLS_GCM_C)
	{ MBEDTLS_TLS_SABER_ECDSA_WITH_AES_256_GCM_SHA256, "TLS-SABER-ECDSA-WITH-AES-256-GCM-SHA256",
	MBEDTLS_CIPHER_AES_256_GCM, MBEDTLS_MD_SHA256, MBEDTLS_KEY_EXCHANGE_SABER_ECDSA,
	MBEDTLS_SSL_MAJOR_VERSION_3, MBEDTLS_SSL_MINOR_VERSION_3,
	MBEDTLS_SSL_MAJOR_VERSION_3, MBEDTLS_SSL_MINOR_VERSION_3,
	0 },
#endif /* MBEDTLS_GCM_C */
...
#if defined(MBEDTLS_SHA256_C)
#if defined(MBEDTLS_GCM_C)
	{ MBEDTLS_TLS_KYBER_ECDSA_WITH_AES_256_GCM_SHA256, "TLS-KYBER-ECDSA-WITH-AES-256-GCM-SHA256",
	MBEDTLS_CIPHER_AES_256_GCM, MBEDTLS_MD_SHA256, MBEDTLS_KEY_EXCHANGE_KYBER_ECDSA,
	MBEDTLS_SSL_MAJOR_VERSION_3, MBEDTLS_SSL_MINOR_VERSION_3,
	MBEDTLS_SSL_MAJOR_VERSION_3, MBEDTLS_SSL_MINOR_VERSION_3,
	0 },
#endif /* MBEDTLS_GCM_C */
...
#if defined(MBEDTLS_SHA256_C)
#if defined(MBEDTLS_GCM_C)
	{ MBEDTLS_TLS_ECDHE_SPHINCS_WITH_AES_256_GCM_SHA256, "TLS-ECDHE-SPHINCS-WITH-AES-256-GCM-SHA256",
	MBEDTLS_CIPHER_AES_256_GCM, MBEDTLS_MD_SHA256, MBEDTLS_KEY_EXCHANGE_ECDHE_SPHINCS,
	MBEDTLS_SSL_MAJOR_VERSION_3, MBEDTLS_SSL_MINOR_VERSION_3,
	MBEDTLS_SSL_MAJOR_VERSION_3, MBEDTLS_SSL_MINOR_VERSION_3,
	0 },
#endif /* MBEDTLS_GCM_C */
#endif /* MBEDTLS_SHA256_C */
#endif /* MBEDTLS_AES_C */
#endif /* MBEDTLS_KEY_EXCHANGE_ECDHE_SPHINCS_ENABLED */
...
#endif /* MBEDTLS_CIPHER_MODE_CBC */
#if defined(MBEDTLS_GCM_C)
    { MBEDTLS_TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA256, "TLS-ECDHE-ECDSA-WITH-AES-256-GCM-SHA256",
      MBEDTLS_CIPHER_AES_256_GCM, MBEDTLS_MD_SHA256, MBEDTLS_KEY_EXCHANGE_ECDHE_ECDSA,
      MBEDTLS_SSL_MAJOR_VERSION_3, MBEDTLS_SSL_MINOR_VERSION_3,
      MBEDTLS_SSL_MAJOR_VERSION_3, MBEDTLS_SSL_MINOR_VERSION_3,
      0 },
