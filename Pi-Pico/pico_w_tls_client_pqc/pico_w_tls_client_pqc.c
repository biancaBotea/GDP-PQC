...
int main() {
    ...
    const size_t mbedtls_test_ca_crt_sphincs_shake256_pem_len = sizeof(mbedtls_test_ca_crt_sphincs_shake256_pem);
    ...
    ret = mbedtls_x509_crt_parse(&cacert, (const unsigned char *)mbedtls_test_ca_crt_sphincs_shake256_pem,
		mbedtls_test_ca_crt_sphincs_shake256_pem_len);
	if( ret < 0 )
    {
