...
int main( void )
{
    ...
    ret = mbedtls_x509_crt_parse(&cacert, (const unsigned char *)TEST_CA_CRT_DILITHIUM_SHAKE256_PEM,
                                 strlen(TEST_CA_CRT_DILITHIUM_SHAKE256_PEM)+1);
	if( ret < 0 )
    {
...
#if defined(MBEDTLS_PEFORMANCE)
	mbedtls_printf("%f,%f,%f,%f,%i,%i,%i,%i,%i,%i,%i,%i,%i,%i,%f\n",
